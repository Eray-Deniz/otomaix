...
| Phase | Tasks | Durum | Commit / Not |
|---|---|---|---|
| **A — Skeleton** | 1 | ✅ | `bb8a379` |
| **B — Templates** | 2 | ✅ | `c39724f` |
| **C — /handoff komutu** | 3 | ✅ | global, commit yok |
| **D — Mevcut command entegrasyonu** | 4–8 (5 ayrı edit) | ✅ | global, commit yok |
